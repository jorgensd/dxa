...
class AssembleBlock(Block):
    def __init__(
        self, form: dolfinx.fem.Form, ad_block_tag: typing.Optional[str] = None
    ):
        ...
        for c in self.form._original_ufl_form.coefficients():
            self.add_dependency(c, no_duplicates=True)
        breakpoint()
    def __str__(self):
        return f"assemble({ufl2unicode(self.form._original_ufl_form)})"
